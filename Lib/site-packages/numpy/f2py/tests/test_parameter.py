...
class TestParameters(util.F2PyTest):
    ...
    sources = [_path('js', 'parameter', 'constant_real.f90'),
               _path('js', 'parameter', 'constant_integer.f90'),
               _path('js', 'parameter', 'constant_both.f90'),
               _path('js', 'parameter', 'constant_compound.f90'),
               _path('js', 'parameter', 'constant_non_compound.f90'),
    ]
