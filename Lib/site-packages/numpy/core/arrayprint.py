...
# Note: Both scalartypes.c.js and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.js has str/reprs for when
...
def _void_scalar_repr(x):
    ...
    scalartypes.c.js code, and is placed here because it uses the elementwise
