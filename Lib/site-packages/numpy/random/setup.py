...
def configuration(parent_package='', top_path=None):
    ...
    npyrandom_sources = [
        'js/distributions/logfactorial.c',
        'js/distributions/distributions.c',
        'js/distributions/random_mvhg_count.c',
        'js/distributions/random_mvhg_marginals.c',
        'js/distributions/random_hypergeometric.c',
    ]
    ...
    for gen in ['mt19937']:
        # gen.pyx, js/gen/gen.c, js/gen/gen-jump.c
        config.add_extension(f'_{gen}',
                             sources=[f'_{gen}.c',
                                      f'js/{gen}/{gen}.c',
                                      f'js/{gen}/{gen}-jump.c'],
                             include_dirs=['.', 'js', join('js', gen)],
    ...
    for gen in ['_generator', '_bounded_integers']:
        # gen.pyx, js/distributions/distributions.c
        config.add_extension(gen,
                             sources=[f'{gen}.c'],
                             libraries=EXTRA_LIBRARIES,
                             extra_compile_args=EXTRA_COMPILE_ARGS,
    ...
    config.add_extension('mtrand',
                         sources=['mtrand.c',
                                  'js/legacy/legacy-distributions.c',
                                  'js/distributions/distributions.c',
                                 ],
                         include_dirs=['.', 'js', 'js/legacy'],
