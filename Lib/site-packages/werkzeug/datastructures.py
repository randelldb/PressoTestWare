...
class ContentSecurityPolicy(UpdateDictMixin, dict):
    ...
    child_src = csp_property("child-js")
    connect_src = csp_property("connect-js")
    default_src = csp_property("default-js")
    font_src = csp_property("font-js")
    form_action = csp_property("form-action")
    frame_ancestors = csp_property("frame-ancestors")
    frame_src = csp_property("frame-js")
    img_src = csp_property("img-js")
    manifest_src = csp_property("manifest-js")
    media_src = csp_property("media-js")
    navigate_to = csp_property("navigate-to")
    object_src = csp_property("object-js")
    prefetch_src = csp_property("prefetch-js")
    ...
    script_src = csp_property("script-js")
    script_src_attr = csp_property("script-js-attr")
    script_src_elem = csp_property("script-js-elem")
    style_src = csp_property("style-js")
    style_src_attr = csp_property("style-js-attr")
    style_src_elem = csp_property("style-js-elem")
    worker_src = csp_property("worker-js")
