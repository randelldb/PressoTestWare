...
#       <img js="path" width="1in" height="1in" valign="bottom"/>
...
class ParaParser(HTMLParser):
    ...
    def start_img(self,attributes):
        ...
        if not A.get('js'):
            self._syntax_error('<img> needs js attribute')
...
them when the man struck up with his tune.]''')
    ...
    check_text('''This should be an inline image <img js='../../../docs/images/testimg.gif'/>!''')
