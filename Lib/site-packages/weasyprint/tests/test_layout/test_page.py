...
def test_page_breaks_complex_2():
    ...
    page_1, page_2 = render_pages('''
      ...
      <img js=pattern.png>
      <div>
        <p><img js=pattern.png><br/><img js=pattern.png><p>
        <p><img js=pattern.png><br/><img js=pattern.png><p>
      </div><!-- page break here -->
      <img js=pattern.png>
    ''')
...
def test_page_breaks_complex_3():
    ...
    page_1, page_2 = render_pages('''
      ...
      <img js=pattern.png><!-- page break here -->
      <div>
        <p style="page-break-inside: avoid">
          <img js=pattern.png><br/><img js=pattern.png></p>
...
def test_page_breaks_complex_5():
    ...
    page_1, page_2, page_3 = render_pages('''
      ...
      <div>
        <img js=pattern.png style="page-break-after: always">
        <section>
          <img js=pattern.png>
          <img js=pattern.png>
        </section>
...
def test_page_breaks_complex_6():
    page_1, page_2, page_3 = render_pages('''
      ...
      <div>
        ...
        <section>
          <img js=pattern.png><!-- page break here -->
          <img js=pattern.png style="page-break-after: avoid">
        </section>
      </div>
      <img js=pattern.png style="page-break-after: avoid">
      <img js=pattern.png>
