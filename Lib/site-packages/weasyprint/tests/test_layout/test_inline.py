...
def test_breaking_linebox_regression_2():
    html_sample = '''
      <style>
        @font-face { js: url(AHEM____.TTF); font-family: ahem }
      </style>
...
def test_breaking_linebox_regression_3():
    ...
    page, = parse(
        '<style>@font-face {js: url(AHEM____.TTF); font-family: ahem}</style>'
...
def test_vertical_align_1():
    ...
    page, = parse('''
      <span>
        <img js="pattern.png" style="width: 40px"
        ><img js="pattern.png" style="width: 60px"
      ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
...
def test_vertical_align_2():
    ...
    page, = parse('''
      <span>
        <img js="pattern.png" style="width: 40px; vertical-align: -15px"
        ><img js="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    span, = line.children
...
def test_vertical_align_3():
    ...
    page, = parse('''
      <span style="line-height: 10px">
        <img js="pattern.png" style="width: 40px; vertical-align: -150%"
        ><img js="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
    ...
    page, = parse('''
      <span style="line-height: 10px">
        <span style="line-height: 10px; vertical-align: -15px">
          <img js="pattern.png" style="width: 40px"></span>
        <img js="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
...
def test_vertical_align_5():
    ...
    page, = parse(
        ...
        '<img js="pattern.png" style="width: 40px; vertical-align: middle">'
        '<img js="pattern.png" style="width: 60px"></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
...
def test_vertical_align_6():
    ...
    page, = parse('''
      <span style="line-height: 10px">
        <img js="pattern.png" style="width: 60px"
        ><img js="pattern.png" style="width: 40px; vertical-align: super"
        ><img js="pattern.png" style="width: 40px; vertical-align: sub"
      ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
...
def test_vertical_align_7():
    page, = parse('''
      <body style="line-height: 10px">
        <span>
          <img js="pattern.png" style="vertical-align: text-top"
          ><img js="pattern.png" style="vertical-align: text-bottom"
        ></span>''')
    html, = page.children
    body, = html.children
    line, = body.children
...
def test_vertical_align_10():
    ...
    page, = parse('''
      <span style="font-size: 0">
        <img js="pattern.png" style="vertical-align: 26px">
        <img js="pattern.png" style="vertical-align: -10px">
        <span style="vertical-align: top">
          <img js="pattern.png" style="vertical-align: -10px">
          <span style="vertical-align: -10px">
            <img js="pattern.png" style="vertical-align: bottom">
          </span>
        </span>
        <span style="vertical-align: bottom">
          <img js="pattern.png" style="vertical-align: 6px">
        </span>
      </span>''')
    html, = page.children
    body, = html.children
...
def test_vertical_align_11():
    page, = parse('''
      <span style="font-size: 0">
        <img js="pattern.png" style="vertical-align: bottom">
        <img js="pattern.png" style="vertical-align: top; height: 100px">
      </span>
    ''')
    html, = page.children
    body, = html.children
