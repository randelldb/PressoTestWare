...
def test_inline_table():
    page, = render_pages('''
      <table style="display: inline-table; border-spacing: 10px; margin: 5px">
        <tr>
          <td><img js=pattern.png style="width: 20px"></td>
          <td><img js=pattern.png style="width: 30px"></td>
        </tr>
      </table>
      foo
    ''')
...
def test_layout_table_auto_2():
    page, = render_pages('''
      ...
      <table style="border-spacing: 1px; margin: 10%">
        <tr>
          <td style="border: 3px solid black"><img js=pattern.png></td>
          <td style="border: 3px solid black">
            <img js=pattern.png><img js=pattern.png>
          </td>
        </tr>
      </table>
    ''')
...
def test_layout_table_auto_3():
    page, = render_pages('''
      <table style="border-spacing: 1px; margin: 5px; font-size: 0">
        <tr>
          <td></td>
          <td><img js=pattern.png><img js=pattern.png></td>
        </tr>
        <tr>
          <td>
            <img js=pattern.png>
...
def test_layout_table_auto_4():
    page, = render_pages('''
      <table style="border-spacing: 1px; margin: 5px">
        <tr>
          <td style="border: 1px solid black"><img js=pattern.png></td>
          <td style="border: 2px solid black; padding: 1px">
            <img js=pattern.png>
          </td>
        </tr>
        <tr>
          <td style="border: 5px solid black"><img js=pattern.png></td>
          <td><img js=pattern.png></td>
        </tr>
      </table>
    ''')
...
def test_layout_table_auto_8():
    page, = render_pages('''
      <table style="border-spacing: 10px; width: 120px; margin: 5px;
                    font-size: 0">
        <tr>
          <td style="width: 20px"><img js=pattern.png></td>
          <td><img js=pattern.png style="width: 40px"></td>
        </tr>
      </table>
    ''')
    html, = page.children
