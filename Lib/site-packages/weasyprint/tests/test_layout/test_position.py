...
def test_relative_positioning_2():
    page, = parse('''
      ...
      <span style="position: relative; left: 10px">
        ...
        <img js=pattern.png style="position: relative">
        <img js=pattern.png>
      </span>
      <span><img js=pattern.png></span>
    ''')
...
def test_absolute_images():
    page, = parse('''
      ...
      <div style="margin: 10px">
        <img js=pattern.png />
        <img js=pattern.png style="left: 15px" />
      </div>
    ''')
    html, = page.children
    body, = html.children
...
def test_fixed_positioning_regression_1():
    ...
    page_1, page_2 = parse('''
      ...
      <img class="fixed" style="right: 20px" js="pattern.png" />
