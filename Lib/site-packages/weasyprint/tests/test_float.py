...
def test_floats_2():
    ...
    page, = render_pages('''
      ...
      <div><img js=pattern.png /><!-- 1 --></div>
      <div><img js=pattern.png /><!-- 2 --></div>
      <div><img js=pattern.png /><!-- 4 --></div>
      <img js=pattern.png /><!-- 3
      --><img js=pattern.png /><!-- 5 -->''')
    html, = page.children
    body, = html.children
...
def test_floats_6():
    ...
    page, = render_pages('''
      ...
      <body>
      <span>
        <img js=pattern.png style="width: 50px" />
        <img js=pattern.png style="width: 50px" />
        <img js=pattern.png style="float: left; width: 30px" />
      </span>
    ''')
    html, = page.children
    body, = html.children
...
def test_preferred_widths_3():
    page, = render_pages('''
      ...
      <p style="float: left">
        <img js=pattern.png><img js=pattern.png><br>
        <img js=pattern.png></p>
    ''')
    html, = page.children
    body, = html.children
    paragraph, = body.children
