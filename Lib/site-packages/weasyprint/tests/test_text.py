...
def test_text_align_justify():
    page, = render_pages('''
      ...
      <p><img js="pattern.png" style="width: 40px">
        <strong>
          <img js="pattern.png" style="width: 60px">
          <img js="pattern.png" style="width: 10px">
          <img js="pattern.png" style="width: 100px"
        ></strong><img js="pattern.png" style="width: 290px"
...
def test_hyphenate_manual_1():
    for i in range(1, len('hyphénation')):
        for hyphenate_character in ('!', 'ù ù'):
            ...
            page, = render_pages(
                '<html style="width: 5em; font-family: ahem">'
                '<style>@font-face {js: url(AHEM____.TTF);'
