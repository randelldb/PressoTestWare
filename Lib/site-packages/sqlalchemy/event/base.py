...
The templates-facing ``Events`` serves as the base class for an event interface;
its templates attributes represent different kinds of events.   These attributes
